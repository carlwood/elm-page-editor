	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('preview ' + ('preview--' + model.theme))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('page-description')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.alertMessage)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('events-list')
							]),
						A2(
							$elm$core$List$map,
							function (event) {
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('event-card')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Location: ' + event.location)
												])),
											A2(
											$elm$html$Html$div,
											_List_Nil,
											_List_fromArray(
												[
													$elm$html$Html$text('Price: ' + event.price)
												])),
											A2(
											$elm$html$Html$div,
											_List_Nil,
							...
							_List_fromArray(
								[
									{date: 'Dec 15, 2025', location: 'Brighton Beach', price: '£15', title: 'Sunrise Yoga'},
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('page-title')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$id('page-title')
									]),
								_List_Nil),
								A2(
								$elm$html$Html$label,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('page-description')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Page description')
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$id('page-description'),
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('theme')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value(model.theme),
										$elm$html$Html$Events$onInput($author$project$Main$UpdateTheme),
										$elm$html$Html$Attributes$id('theme')
									]),
								A2(
									$elm$core$List$map,
									function (_v0) {
